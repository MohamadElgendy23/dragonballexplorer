...
function NavBar() {
  return (
    <nav className="flex justify-between bg-white items-center">
        ...
        <button className="font-sans min-w-40 bg-amber-300 shadow-none text-white pt-1.5 pb-1.5 pl-4 pr-4 mr-10 rounded-sm text-2xl leading-6 tracking-wide cursor-pointer hover:bg-amber-400">Docs</button>
    </nav>
  )
}
